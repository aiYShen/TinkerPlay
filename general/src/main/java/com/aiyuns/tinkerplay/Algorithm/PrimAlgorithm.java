...
/**
 * @Author: aiYunS @Date: 2022-10-11 下午 02:58 @Description: 普利姆算法 * 应用案例：修路问题 *
 *
 * <p>* 思路分析 * 1.从<A>顶点开始处理=><A,G> 2 * A,C[7] A-G[2] A-B[5] => *
 * 2.<A,G>开始，将A和G顶点和他们相邻的还没有访问的顶面进行处理=> <A,G,B> * A-C[7] A-B[5] G-B[3] G-F[6] *
 * 3.<A,G,B>开始，将A,G,B顶点和他们相邻的还没有访问的顶面进行处理=> <A,G,B> * A-C[7] G-E[4] G-F[6] B-D[9] * ... *
