...
/**
 * 线性回归: 找到一条直线（或更高维的超平面），让这条线尽可能“贴近”所有数据点
 * y=w⋅x+b
 * y：预测的房价
 * x：房屋面积
 * w：斜率，表示面积每增加1单位，房价增加多少
...
public class LinearRegression {
    public static void main(String[] args) {
        ...
        try {
            ChartUtils.saveChartAsPNG(new File(desktopPath + "linear_regression_fit.png"), chart1, 800, 600);
        ...
        try {
            ChartUtils.saveChartAsPNG(new File(desktopPath + "linear_regression_optimization.png"), chart2, 800, 600);
